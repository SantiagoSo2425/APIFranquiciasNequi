package co.com.nequi.franquicias.config;

// Commented out - AWS Secrets Manager not used in this project
// If needed in production, add AWS SDK dependency to build.gradle
